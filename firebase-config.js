...
//   try {
//     // Check if using test credentials (no Firebase)
//     const testUserId = sessionStorage.getItem("test-user-uid");
//     if (testUserId && typeof auth === 'undefined') {
//       console.warn("Using test credentials, loading from local storage");
...
//     const testUserId = sessionStorage.getItem("test-user-uid");
//     if (testUserId && typeof auth === 'undefined') {
//       console.warn("Using test credentials, saving to local storage only");
